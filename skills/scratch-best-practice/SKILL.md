---
name: scratch-best-practice
description: >
  review scratch code and planning work against common scratch conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic scratch, scratch project review, scratch refactoring guidance, scratch classroom conventions, or scratch project organization.
---

# Scratch Best Practice

Use this skill to review or improve Scratch work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Scratch | `references/best-practices.md` |
...
```text
Review this Scratch module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Scratch snippet to follow common Scratch best practice without changing behavior.
```
