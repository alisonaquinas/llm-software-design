---
name: solidity-best-practice
description: >
  review solidity code and planning work against common solidity conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic solidity, solidity code review, smart contract refactoring guidance, or solidity style and security conventions.
---

# Solidity Best Practice

Use this skill to review or improve Solidity work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Solidity | `references/best-practices.md` |
...
```text
Review this Solidity module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Solidity snippet to follow common Solidity best practice without changing behavior.
```
