---
name: haskell-best-practice
description: >
  review haskell code and planning work against common haskell conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic haskell, haskell code review, haskell refactoring guidance, haskell module design, or haskell style and totality conventions.
---

# Haskell Best Practice

Use this skill to review or improve Haskell work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Haskell | `references/best-practices.md` |
...
```text
Review this Haskell module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Haskell snippet to follow common Haskell best practice without changing behavior.
```
