---
name: delphi-object-pascal-best-practice
description: >
  review delphi/object pascal code and planning work against common delphi/object pascal conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic delphi, object pascal code review, delphi refactoring guidance, delphi project structure, or delphi formatting and naming conventions.
---

# Delphi/Object Pascal Best Practice

Use this skill to review or improve Delphi/Object Pascal work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Delphi/Object Pascal | `references/best-practices.md` |
...
```text
Review this Delphi/Object Pascal module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Delphi/Object Pascal snippet to follow common Delphi/Object Pascal best practice without changing behavior.
```
