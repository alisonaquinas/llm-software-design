...
description: >
  review c code and planning work against common c conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic c, c code review, c refactoring guidance, c project structure, or c tooling such as clang-format, sanitizers, or static analysis.
---
