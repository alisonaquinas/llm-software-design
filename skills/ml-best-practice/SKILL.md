...
description: >
  review ml code and planning work against common ml conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic ml, standard ml code review, ml refactoring guidance, ml module design, or ml functional programming conventions.
---

# ML Best Practice

Use this skill to review or improve ML work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for ML | `references/best-practices.md` |
...
```text
Review this ML module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this ML snippet to follow common ML best practice without changing behavior.
```
