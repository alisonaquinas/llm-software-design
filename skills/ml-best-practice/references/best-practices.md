...
- Confirm the dialect and compiler first; Standard ML and close relatives differ in libraries, modules, and tooling.
- Prefer pure functions, explicit signatures, and small modules that communicate data flow clearly.
- Use algebraic data types and exhaustive pattern matching to make states and transitions obvious.
- Keep imperative references, exceptions, and mutable arrays localized to the edges that truly need them.
- Document functor and module assumptions because abstraction can become opaque quickly in ML-family code.
...
- [The Standard ML Basis Library](https://smlfamily.github.io/Basis/)
- [Programming in Standard ML](https://saityi.github.io/sml-tour/)
