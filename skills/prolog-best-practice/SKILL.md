---
name: prolog-best-practice
description: >
  review prolog code and planning work against common prolog conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic prolog, prolog code review, prolog refactoring guidance, prolog module structure, or prolog documentation and test conventions.
---

# Prolog Best Practice

Use this skill to review or improve Prolog work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Prolog | `references/best-practices.md` |
...
```text
Review this Prolog module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Prolog snippet to follow common Prolog best practice without changing behavior.
```
