...
description: >
  review php code and planning work against common php conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic php, php code review, php refactoring guidance, php project structure, or php tooling such as psr-12, phpstan, or phpunit.
---

# PHP Best Practice

Use this skill to review or improve PHP work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for PHP | `references/best-practices.md` |
...
```text
Review this PHP module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this PHP snippet to follow common PHP best practice without changing behavior.
```
