---
name: scala-best-practice
description: >
  review scala code and planning work against common scala conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic scala, scala code review, scala refactoring guidance, scala project structure, or scala formatting and type-inference conventions.
---

# Scala Best Practice

Use this skill to review or improve Scala work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Scala | `references/best-practices.md` |
...
```text
Review this Scala module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Scala snippet to follow common Scala best practice without changing behavior.
```
