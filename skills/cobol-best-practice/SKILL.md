---
name: cobol-best-practice
description: >
  review cobol code and planning work against common cobol conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic cobol, cobol code review, cobol refactoring guidance, cobol data structure conventions, or maintainable cobol design.
---

# COBOL Best Practice

Use this skill to review or improve COBOL work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for COBOL | `references/best-practices.md` |
...
```text
Review this COBOL module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this COBOL snippet to follow common COBOL best practice without changing behavior.
```
