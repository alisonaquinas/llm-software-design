...
description: >
  review zig code and planning work against common zig conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic zig, zig code review, zig refactoring guidance, zig package structure, or zig allocator and error-handling conventions.
---

# Zig Best Practice

Use this skill to review or improve Zig work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Zig | `references/best-practices.md` |
...
```text
Review this Zig module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Zig snippet to follow common Zig best practice without changing behavior.
```
