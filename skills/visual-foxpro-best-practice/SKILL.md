---
name: visual-foxpro-best-practice
description: >
  review (visual) foxpro code and planning work against common (visual) foxpro conventions for formatting, naming, structure, testing, and tooling. use when the user asks for visual foxpro code review, foxpro refactoring guidance, legacy foxpro maintenance, or foxpro data and ui separation practices.
---

# (Visual) FoxPro Best Practice

Use this skill to review or improve (Visual) FoxPro work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for (Visual) FoxPro | `references/best-practices.md` |
...
```text
Review this (Visual) FoxPro module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this (Visual) FoxPro snippet to follow common (Visual) FoxPro best practice without changing behavior.
```
