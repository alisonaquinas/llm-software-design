---
name: sql-best-practice
description: >
  review sql code and planning work against common sql conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic sql, sql code review, sql refactoring guidance, sql schema work, query tuning, or sql style and naming conventions.
---
...
```text
Review this SQL module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this SQL snippet to follow common SQL best practice without changing behavior.
```
