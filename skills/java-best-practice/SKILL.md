...
description: >
  review java code and planning work against common java conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic java, java code review, java refactoring guidance, java project structure, or java tooling such as spotless, checkstyle, or junit.
---

# Java Best Practice

Use this skill to review or improve Java work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Java | `references/best-practices.md` |
...
```text
Review this Java module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Java snippet to follow common Java best practice without changing behavior.
```
