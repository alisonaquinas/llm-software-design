---
name: swift-best-practice
description: >
  review swift code and planning work against common swift conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic swift, swift code review, swift refactoring guidance, swift package structure, or swift api design and concurrency conventions.
---

# Swift Best Practice

Use this skill to review or improve Swift work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Swift | `references/best-practices.md` |
...
```text
Review this Swift module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Swift snippet to follow common Swift best practice without changing behavior.
```
