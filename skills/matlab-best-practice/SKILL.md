---
name: matlab-best-practice
description: >
  review matlab code and planning work against common matlab conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic matlab, matlab code review, matlab refactoring guidance, matlab project structure, or matlab style and testing conventions.
---

# MATLAB Best Practice

Use this skill to review or improve MATLAB work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for MATLAB | `references/best-practices.md` |
...
```text
Review this MATLAB module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this MATLAB snippet to follow common MATLAB best practice without changing behavior.
```
