---
name: xpp-best-practice
description: >
  review x++ code and planning work against common x++ conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic x++, x++ code review, x++ refactoring guidance, dynamics 365 extensibility, or x++ class and method design.
---

# X++ Best Practice

Use this skill to review or improve X++ work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for X++ | `references/best-practices.md` |
...
```text
Review this X++ module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this X++ snippet to follow common X++ best practice without changing behavior.
```
