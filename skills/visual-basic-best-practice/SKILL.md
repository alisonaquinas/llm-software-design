---
name: visual-basic-best-practice
description: >
  review visual basic code and planning work against common visual basic conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic visual basic, vb.net code review, visual basic refactoring guidance, visual basic project structure, or visual basic conventions on .net.
---

# Visual Basic Best Practice

Use this skill to review or improve Visual Basic work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Visual Basic | `references/best-practices.md` |
...
```text
Review this Visual Basic module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Visual Basic snippet to follow common Visual Basic best practice without changing behavior.
```
