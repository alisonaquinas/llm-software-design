---
name: kotlin-best-practice
description: >
  review kotlin code and planning work against common kotlin conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic kotlin, kotlin code review, kotlin refactoring guidance, kotlin project structure, or kotlin tooling such as ktlint, detekt, and coroutines.
---
...
| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Kotlin | `references/best-practices.md` |
