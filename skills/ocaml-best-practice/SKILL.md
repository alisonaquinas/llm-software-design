---
name: ocaml-best-practice
description: >
  review ocaml code and planning work against common ocaml conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic ocaml, ocaml code review, ocaml refactoring guidance, ocaml module design, or ocaml formatting and dune conventions.
---

# OCaml Best Practice

Use this skill to review or improve OCaml work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for OCaml | `references/best-practices.md` |
...
```text
Review this OCaml module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this OCaml snippet to follow common OCaml best practice without changing behavior.
```
