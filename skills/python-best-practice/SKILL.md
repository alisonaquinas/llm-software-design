...
description: >
  review python code and planning work against common python conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic python, python code review, python refactoring guidance, python project structure, or python tooling such as ruff, black, or pytest.
---

# Python Best Practice

Use this skill to review or improve Python work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Python | `references/best-practices.md` |
...
```text
Review this Python module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Python snippet to follow common Python best practice without changing behavior.
```
