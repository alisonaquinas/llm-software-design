---
name: assembly-language-best-practice
description: >
  review assembly language code and planning work against common assembly language conventions for formatting, naming, structure, testing, and tooling. use when the user asks for assembly code review, idiomatic assembly, assembly refactoring guidance, low-level calling conventions, register usage, or abi-aware assembly practices.
---

# Assembly language Best Practice

Use this skill to review or improve Assembly language work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Assembly language | `references/best-practices.md` |
...
```text
Review this Assembly language module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Assembly language snippet to follow common Assembly language best practice without changing behavior.
```
