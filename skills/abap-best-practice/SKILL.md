---
name: abap-best-practice
description: >
  review abap code and planning work against common abap conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic abap, abap code review, abap refactoring guidance, clean abap, or abap package and method conventions.
---

# ABAP Best Practice

Use this skill to review or improve ABAP work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for ABAP | `references/best-practices.md` |
...
```text
Review this ABAP module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this ABAP snippet to follow common ABAP best practice without changing behavior.
```
