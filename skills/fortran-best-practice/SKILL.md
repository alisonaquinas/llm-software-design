---
name: fortran-best-practice
description: >
  review fortran code and planning work against common fortran conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic fortran, fortran code review, fortran refactoring guidance, fortran project structure, or fortran formatting and module conventions.
---

# Fortran Best Practice

Use this skill to review or improve Fortran work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Fortran | `references/best-practices.md` |
...
```text
Review this Fortran module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Fortran snippet to follow common Fortran best practice without changing behavior.
```
