---
name: awk-best-practice
description: >
  review awk code and planning work against common awk conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic awk, awk code review, awk refactoring guidance, gawk best practices, or maintainable awk scripts.
---

# Awk Best Practice

Use this skill to review or improve Awk work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Awk | `references/best-practices.md` |
...
```text
Review this Awk module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Awk snippet to follow common Awk best practice without changing behavior.
```
