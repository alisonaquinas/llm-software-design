---
name: ladder-logic-best-practice
description: >
  review ladder logic code and planning work against common ladder logic conventions for formatting, naming, structure, testing, and tooling. use when the user asks for ladder logic review, plc refactoring guidance, iec 61131-3 ladder logic practices, or maintainable ladder logic structure and naming.
---

# Ladder Logic Best Practice

Use this skill to review or improve Ladder Logic work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Ladder Logic | `references/best-practices.md` |
...
```text
Review this Ladder Logic module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Ladder Logic snippet to follow common Ladder Logic best practice without changing behavior.
```
