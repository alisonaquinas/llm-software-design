---
name: elixir-best-practice
description: >
  review elixir code and planning work against common elixir conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic elixir, elixir code review, elixir refactoring guidance, otp design, or elixir tooling such as mix format, credo, and exunit.
---

# Elixir Best Practice

Use this skill to review or improve Elixir work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Elixir | `references/best-practices.md` |
...
```text
Review this Elixir module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Elixir snippet to follow common Elixir best practice without changing behavior.
```
