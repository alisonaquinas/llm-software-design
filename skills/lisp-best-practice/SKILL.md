---
name: lisp-best-practice
description: >
  review lisp code and planning work against common lisp conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic lisp, lisp code review, lisp refactoring guidance, lisp macro design, or lisp project organization.
---

# Lisp Best Practice

Use this skill to review or improve Lisp work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Lisp | `references/best-practices.md` |
...
```text
Review this Lisp module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Lisp snippet to follow common Lisp best practice without changing behavior.
```
