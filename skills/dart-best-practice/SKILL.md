...
description: >
  review dart code and planning work against common dart conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic dart, dart code review, dart refactoring guidance, dart package structure, or dart tooling such as dart format, analyzer, and tests.
---

# Dart Best Practice

Use this skill to review or improve Dart work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Dart | `references/best-practices.md` |
...
```text
Review this Dart module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Dart snippet to follow common Dart best practice without changing behavior.
```
