---
name: classic-visual-basic-best-practice
description: >
  review classic visual basic code and planning work against common classic visual basic conventions for formatting, naming, structure, testing, and tooling. use when the user asks for classic visual basic code review, vb6 refactoring guidance, legacy visual basic maintenance, or classic visual basic project organization.
---

# Classic Visual Basic Best Practice

Use this skill to review or improve Classic Visual Basic work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Classic Visual Basic | `references/best-practices.md` |
...
```text
Review this Classic Visual Basic module for idiomatic structure, naming, boundary handling, and test gaps.
```
