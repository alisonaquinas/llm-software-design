# Classic Visual Basic best practices
...
- Preserve behavior first; prefer small, well-tested improvements over wholesale rewrites in stable legacy systems.
- Use `Option Explicit`, clear control names, and descriptive procedure names to reduce ambiguity in event-heavy code.
- Separate UI forms, database access, and business rules as much as the existing project model allows.
- Make COM boundaries, error handling, and null or empty semantics explicit in comments and wrapper routines.
- Document compatibility assumptions, deployment dependencies, and migration hotspots near the affected modules.
...
- [Classic VB language reference mirror](https://vb.mvps.org/lang/)
