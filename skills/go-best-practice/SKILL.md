...
description: >
  review go code and planning work against common go conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic go, golang code review, go refactoring guidance, go package structure, or go tooling such as gofmt, go vet, and table-driven tests.
---

# Go Best Practice

Use this skill to review or improve Go work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Go | `references/best-practices.md` |
...
```text
Review this Go module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Go snippet to follow common Go best practice without changing behavior.
```
