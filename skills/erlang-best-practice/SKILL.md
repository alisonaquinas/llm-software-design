---
name: erlang-best-practice
description: >
  review erlang code and planning work against common erlang conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic erlang, erlang code review, erlang refactoring guidance, otp design, or erlang process and supervision conventions.
---

# Erlang Best Practice

Use this skill to review or improve Erlang work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Erlang | `references/best-practices.md` |
...
```text
Review this Erlang module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Erlang snippet to follow common Erlang best practice without changing behavior.
```
