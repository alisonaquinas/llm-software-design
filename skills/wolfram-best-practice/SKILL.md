---
name: wolfram-best-practice
description: >
  review wolfram code and planning work against common wolfram conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic wolfram language, mathematica code review, wolfram refactoring guidance, or wolfram package and notebook conventions.
---

# Wolfram Best Practice

Use this skill to review or improve Wolfram work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Wolfram | `references/best-practices.md` |
...
```text
Review this Wolfram module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Wolfram snippet to follow common Wolfram best practice without changing behavior.
```
