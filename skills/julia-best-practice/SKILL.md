---
name: julia-best-practice
description: >
  review julia code and planning work against common julia conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic julia, julia code review, julia refactoring guidance, julia package structure, or julia style and performance conventions.
---

# Julia Best Practice

Use this skill to review or improve Julia work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Julia | `references/best-practices.md` |
...
```text
Review this Julia module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Julia snippet to follow common Julia best practice without changing behavior.
```
