...
description: >
  review typescript code and planning work against common typescript conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic typescript, typescript code review, typescript refactoring guidance, ts project structure, or typescript tooling such as eslint, strict mode, and tests.
---

# TypeScript Best Practice

Use this skill to review or improve TypeScript work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for TypeScript | `references/best-practices.md` |
...
```text
Review this TypeScript module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this TypeScript snippet to follow common TypeScript best practice without changing behavior.
```
