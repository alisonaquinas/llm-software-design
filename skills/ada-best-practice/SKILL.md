---
name: ada-best-practice
description: >
  review ada code and planning work against common ada conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic ada, ada code review, ada refactoring guidance, ada package design, or ada quality and style guidance.
---

# Ada Best Practice

Use this skill to review or improve Ada work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Ada | `references/best-practices.md` |
...
```text
Review this Ada module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Ada snippet to follow common Ada best practice without changing behavior.
```
