...
- Use packages, private types, contracts, and subtype constraints to make invariants explicit in the type system.
- Favor descriptive names, symbolic values, and range-aware declarations over repeated literals.
- Keep exception use deliberate and document error semantics at package boundaries.
- Prefer analyzable, testable code structure over clever generic or tasking tricks in ordinary business logic.
- Preserve readability and portability across compilers and safety-oriented toolchains.
...
- [Ada Quality and Style Guide](https://www.adaic.org/resources/add_content/docs/95style/html/)
- [Ada Resource Association standards](https://www.adaic.org/ada-resources/standards/)
