---
name: lua-best-practice
description: >
  review lua code and planning work against common lua conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic lua, lua code review, lua refactoring guidance, lua module design, or lua embedding and scripting conventions.
---

# Lua Best Practice

Use this skill to review or improve Lua work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Lua | `references/best-practices.md` |
...
```text
Review this Lua module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Lua snippet to follow common Lua best practice without changing behavior.
```
