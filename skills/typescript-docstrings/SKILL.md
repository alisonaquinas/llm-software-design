---
name: typescript-docstrings
description: >
  document typescript code with tsdoc-style jsdoc comments so external tools can read the embedded api documentation. use when the request is to add, normalize, migrate, review, or explain typescript source documentation, inline api help, or machine-readable comments.
---

# TypeScript Docstrings

Use this skill to add or normalize TSDoc-style JSDoc comments in TypeScript code so external tools can discover API intent without reverse-engineering the implementation.
...
3. Otherwise standardize on TSDoc-style JSDoc comments for the requested TypeScript surface.
...
```text
Add or normalize TypeScript source documentation for this public API without changing behavior.
```
