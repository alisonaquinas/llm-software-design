---
name: plsql-best-practice
description: >
  review pl/sql code and planning work against common pl/sql conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic pl/sql, plsql code review, plsql refactoring guidance, package design, or oracle procedural sql best practices.
---

# PL/SQL Best Practice

Use this skill to review or improve PL/SQL work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for PL/SQL | `references/best-practices.md` |
...
```text
Review this PL/SQL module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this PL/SQL snippet to follow common PL/SQL best practice without changing behavior.
```
