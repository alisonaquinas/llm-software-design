...
description: >
  review rust code and planning work against common rust conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic rust, rust code review, rust refactoring guidance, rust crate structure, or rust tooling such as clippy, rustfmt, and cargo tests.
---
...
```text
Review this Rust module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Rust snippet to follow common Rust best practice without changing behavior.
```
