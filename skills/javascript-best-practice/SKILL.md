...
description: >
  review javascript code and planning work against common javascript conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic javascript, javascript code review, javascript refactoring guidance, javascript project structure, or javascript tooling such as eslint, prettier, or async patterns.
---

# JavaScript Best Practice

Use this skill to review or improve JavaScript work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for JavaScript | `references/best-practices.md` |
...
```text
Review this JavaScript module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this JavaScript snippet to follow common JavaScript best practice without changing behavior.
```
