...
description: >
  review c++ code and planning work against common c++ conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic c++, cpp code review, c++ refactoring guidance, c++ project structure, or c++ tooling such as clang-tidy, sanitizers, or modern c++ guidelines.
---
