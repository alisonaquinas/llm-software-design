---
name: perl-best-practice
description: >
  review perl code and planning work against common perl conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic perl, perl code review, perl refactoring guidance, perl module design, or perl tooling such as perltidy and prove.
---

# Perl Best Practice

Use this skill to review or improve Perl work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Perl | `references/best-practices.md` |
...
```text
Review this Perl module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Perl snippet to follow common Perl best practice without changing behavior.
```
