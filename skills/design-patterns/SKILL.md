...
4. Explain both the benefit and the extra moving parts the pattern introduces.
5. Map the pattern into the language's native idioms instead of recreating textbook UML mechanically.
...
7. When relevant, translate the pattern into the user's language idioms and point out non-pattern alternatives.
