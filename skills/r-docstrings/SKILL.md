...
name: r-docstrings
description: >
  document r code with roxygen2 comments so external tools can read the embedded api documentation. use when the request is to add, normalize, migrate, review, or explain r source documentation, inline api help, or machine-readable comments.
---
