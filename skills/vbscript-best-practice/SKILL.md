---
name: vbscript-best-practice
description: >
  review vbscript code and planning work against common vbscript conventions for formatting, naming, structure, testing, and tooling. use when the user asks for vbscript code review, vbscript refactoring guidance, legacy automation scripts, or maintainable vbscript conventions.
---

# VBScript Best Practice

Use this skill to review or improve VBScript work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for VBScript | `references/best-practices.md` |
...
```text
Review this VBScript module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this VBScript snippet to follow common VBScript best practice without changing behavior.
```
