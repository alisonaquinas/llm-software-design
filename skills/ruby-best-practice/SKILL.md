---
name: ruby-best-practice
description: >
  review ruby code and planning work against common ruby conventions for formatting, naming, structure, testing, and tooling. use when the user asks for idiomatic ruby, ruby code review, ruby refactoring guidance, ruby project structure, or ruby tooling such as rubocop, bundler, and tests.
---

# Ruby Best Practice

Use this skill to review or improve Ruby work using common ecosystem conventions instead of ad hoc local habits.

## Intent Router

| Need | Load |
| --- | --- |
| core conventions, tooling defaults, and review checklist for Ruby | `references/best-practices.md` |
...
```text
Review this Ruby module for idiomatic structure, naming, boundary handling, and test gaps.
```

```text
Refactor this Ruby snippet to follow common Ruby best practice without changing behavior.
```
