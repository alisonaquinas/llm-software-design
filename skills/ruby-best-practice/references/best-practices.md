...
- Optimize for readable intent and object collaboration rather than dense metaprogramming.
- Keep methods small, side effects obvious, and domain terms visible in names and class boundaries.
- Use blocks, enumerables, and value objects idiomatically, but do not hide expensive work behind pleasant syntax.
- Treat gem dependencies, version constraints, and test setup as part of maintainability, not incidental boilerplate.
- Run style, lint, and tests together so the codebase keeps one shared dialect.
